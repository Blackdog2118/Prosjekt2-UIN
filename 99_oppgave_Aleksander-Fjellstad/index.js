...
try {
  ...
  (function UseLetOrConst() {
	// Use let (or const) instead of var to make the function succeed.
	//La til const istedenfor var
    const x = 1;
    if (true) {
	//La til let istedenfor var
      let x = 2;
    }
  ...
  /// Arrow functions ///
	...
	(function UseArrow1() {
		...
		//La til () rundt x, y og { rundt funksjonen. endret også til}
  ...
  /// Destructuring ///
	...
	(function UseObjectDestructuring1() {
		...
		//let{name,age,add}=obj; henter ut informasjonen ifra obj.
  ...
  (function UseParameterDestructuring1() {
	...
	//Siden oppgaven vil ha en array setter vi const a = ['Oslo' , 985];
	const a = ['Oslo' , 985];
	//Her assigner vi name = Oslo og age = 985
	const [name, age]=a
  ...
  /// Property shorthand ///
	...
	(function UsePropertyShorthand() {
		...
		let city = {
			//Fjernet name og age, ingen vitts i å repetere
			name,
			age,
			dutch: !norwegian
		};
  ...
  /// Object Spread Properties (ES2018) ///
	...
	(function UseObjectSpreadProperties1() {
		...
		//{...obj} asigner value 1 til copy ved å si at alt innenfor obj skal være det samme som copy også val:
		let copy = {...obj};
